...
var data = [{
  type: 'table',
  header: {
    values: [["<b>HOUSEHOLD TYPE</b>"], ["<b>HAWAII</b>"],
      ["<b>UNITED STATES</b>"]],
    align: ["center"],
...
var data = [{
  type: 'table',
  header: {
    values: [["<b>VALUE</b>"], ["<b>HAWAII</b>"], ["<b>UNITED STATES</b>"]],
    align: ["center"],
    line: {width: 1, color: '#black'},
    fill: {color: ['#5C5F58']},
    font: {family: "Arial", size: 12, color: "white"}
...
var hawaii= {
  x: ['Under $100K', '$100K - $200K', '$200K - $300K', '$300K - $400K', '$400K - $500K', '$500K - $1M', 'Over $1M'],
  y: ['4,101','9,303','16,357','29,643','28,223','146,938','28,153'],
  type: 'bar',
  name: 'Hawaii',
  marker: {
    color: '#004e7c',
...
var us = {
  x:['Under $100K', '$100K - $200K', '$200K - $300K', '$300K - $400K', '$400K - $500K', '$500K - $1M', 'Over $1M'],
  y: ['12,945,144','19,437,984','16,079,298','10,584,277','6,286,456','10,294,023','1,663,399'],
  type: 'bar',
  name: 'United States',
  marker: {
    color: '#B73225',
